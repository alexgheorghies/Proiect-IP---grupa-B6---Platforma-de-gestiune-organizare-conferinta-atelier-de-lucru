package internal.ConferencePack;
...
public class Uploader {
    String currentUrl="http://myqueen:8082/xwiki/rest/wikis/xwiki/spaces/XWiki/pages/Admin/objects";
    String host="myqueen";
    String user="Admin";
    ...
    public void uploadPresentation () throws Exception {
        ...
        try {
            ...
            nvps.add(new BasicNameValuePair("property#first_name", "Gherasim"));
            nvps.add(new BasicNameValuePair("property#last_name", "Cosmin"));
